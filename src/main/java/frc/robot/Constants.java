...
public final class Constants {
  ...
  public static final class FieldConstants {
    ...
    public static final class Community {
      ...
      public static final double kMidX = Units.inchesToMeters(132.375); // Tape to the left of charging station
      public static final double kOuterX = Units.inchesToMeters(193.25); // Tape to the right of charging station
      ...
      public static final Translation2d[] kRegionCorners = new Translation2d[] {
      ...
      public static final double kBlueChargingStationInnerX = kBlueChargingStationOuterX - kChargingStationWidth;
      public static final double kBlueChargingStationLeftY = kMidY - kTapeWidth;
      public static final double kBlueChargingStationRightY = kBlueChargingStationLeftY - kChargingStationHeight;
      public static final Translation2d[] kBlueChargingStationCorners = new Translation2d[] {
      ...
      public static final Translation2d kBlueChargingStationTopLeftCorner = new Translation2d(
          kBlueChargingStationInnerX, kBlueChargingStationRightY);
      public static final Translation2d[][] kBlueChargingStationSegments = new Translation2d[][] {
      ...
      // Cable bump
      public static final double kCableBumpInnerX = kInnerX + Grids.kOuterX + Units.inchesToMeters(95.25);
      public static final double kCableBumpOuterX = kCableBumpInnerX + Units.inchesToMeters(7);
      public static final Translation2d[] kCableBumpCorners = new Translation2d[] {
    ...
    public static final class Grids {
      ...
      public static final double kLowX = kOuterX - (Units.inchesToMeters(14.25) / 2.0); // Centered when under cube
      // nodes
      ...
      static {
        for (int i = 0; i < kNodeRowCount; i++) {
          ...
          kMid3dTranslations[i] = new Translation3d(
              kMidX, kNodeFirstY + kNodeSeparationY * i, isCube ? kMidCubeZ : kMidConeZ);
          kHigh3dTranslations[i] = new Translation3d(
      ...
      // nodes)
      public static final double kComplexLowXCones = kOuterX - Units.inchesToMeters(16.0) / 2.0; // Centered X under
      // cone
      // nodes
      public static final double kComplexLowXCubes = kLowX; // Centered X under cube nodes
      public static final double kComplexLowOuterYOffset = kNodeFirstY - Units.inchesToMeters(3.0)
          - (Units.inchesToMeters(25.75) / 2.0);

      public static final Translation2d[] kComplexLowTranslations = new Translation2d[] {
    ...
    public static final class LoadingZone {
      ...
      public static final double kSingleSubstationLeftX = FieldConstants.kFieldLength - kDoubleSubstationLength
          - Units.inchesToMeters(88.77);
      public static final double kSingleSubstationCenterX = kSingleSubstationLeftX + (kSingleSubstationWidth / 2.0);
      public static final double kSingleSubstationRightX = kSingleSubstationLeftX + kSingleSubstationWidth;
      public static final Translation2d kSingleSubstationTranslation = new Translation2d(kSingleSubstationCenterX,
          kLeftY);
      ...
      public static final double kSingleSubstationCenterZ = kSingleSubstationLowZ + (kSingleSubstationHeight / 2.0);
      public static final double kSingleSubstationHighZ = kSingleSubstationLowZ + kSingleSubstationHeight;
    }
    ...
    public static final class StagingLocations {
      ...
      public static final Map<Integer, Pose3d> kAprilTags = Map.of(
          1,
          new Pose3d(
